...
label warmth:
    ...
    menu:
            "" "Oh look, my classmates! I guess I should..."
            
            "Approach them, say hello and make an excuse that you need to go to the Dean's office.":
                $ response = True
...
label liveliness:
    ...
    if response is False:
        ...
        un "Not jumping immediately to such a chance to have fun? Considering it even? It seems as though you're at the in-between when it comes to liveliness."
...
label rule:
    ...
    menu:       
            ...
            "I'm sorry, I have a curfew, and it's only up until 10pm.":
                $ response = True
...
label sensitive:
    ...
    "" "Oh, it's Ian! Hmm... I wonder what he wants to show me..."
    
    un "{color=#ffa500}SENSITIVITY{/color} is showing appreciation of other's feelings."
    
    un "{color=#ffa500}EMOTIONAL STABILITY{/color} is the mental state of calmness and composure."
    ...
    menu:
        ...
        "It's nice.":
            $ response = 1
        "It's a bit too cliché... I wonder what Ian thinks about this show.":
            $ response = 2
        "No comment.":
            $ response = 3
...
label open:
    ...
    un "{color=#ffa500}SELF-RELIANCE{/color} is showing confidence in anyone's own abilities to do something without the help of others."
...
label perf:
    ...
    menu:
            ...
            "Approach the woman and whisper that she should work on her English and grammar a bit more.":
                $ response is 1
...
label priv:
    ...
    MC "Alright, but let me ask you a question afterward, ok?"
...
label catell:
    ...
    un "I am Raymond Cattell, the Dean who called you here."
